...
def get_retargeter_config(source: SourceType, target: TargetType) -> dict:
    ...
    if source == SourceType.SOMA and target == TargetType.Q1:
        filename = "soma_to_q1_retargeter_config.json"
        return io_utils.load_json(io_utils.get_config_file("q1", filename))
